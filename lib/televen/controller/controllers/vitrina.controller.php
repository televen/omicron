...
include $GLOBALS["root"] . "lib/televen/model/vitrina.model.php";
...
class vitrina{
	...
	public static function photo_gallery($args){
		$files = array();
		$model = new vitrina_model();
		$folder = $model->getPhotoFolderByBlack();
		
		$path = $GLOBALS['base_URI'] . $GLOBALS['show_URI'] . "vitrina/assets/" . $folder;
