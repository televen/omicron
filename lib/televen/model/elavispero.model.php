...
include $GLOBALS["root"] . $GLOBALS["base_URI"] . $GLOBALS["show_URI"] . "elavispero/configuration.php";

class elavispero_model{
	...
	public function __construct(){
		$this->db = new MySQL(true, "elavispero", $GLOBALS["db_host"], $GLOBALS["db_user"], $GLOBALS["db_password"]);
